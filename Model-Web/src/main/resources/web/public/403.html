...
<head>
    <meta charset="UTF-8">
    <title th:text="${systemInfo.sitename}+'-403'">403</title>
    ...
    <style>
        ...
        .error .container-error-404 {top: 50%;position:relative;height:250px;padding-top:40px;}
